        ...
        while 1:
            ...
            while 1:
                if not attached:
                    ...
                    print("usbip devid: {}".format(hex(cmd.devid)))
                    print("usbip direction: {}".format(hex(cmd.direction)))
                    print("usbip ep: {}".format(hex(cmd.ep)))
                    print("usbip flags: {}".format(hex(cmd.transfer_flags)))
                    print("usbip number of packets: {}".format(hex(cmd.number_of_packets)))
                    print("usbip interval: {}".format(hex(cmd.interval)))
                    print("usbip setup: {}".format(hex(cmd.setup)))
                    print("usbip buffer length: {}".format(hex(cmd.transfer_buffer_length)))
